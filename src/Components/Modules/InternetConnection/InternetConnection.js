            ...
            <div className="col-sm-12 float-sm-right float-md-right float-lg-right float-xl-right">
              <div className="images-header-row">
                <h1 className="images-header__h1">
                  {t('server_specidications')}
                </h1>
              </div>
            </div>
          </div>
          <div className="row justify-content-center">
            <div className="col-sm-6 col-md-5 col-lg-4 px-0">
              <div className="internet-maindiv__firstDiv h-100 ">
                ...
                <div className="maindiv">
                  <div className="internet-maindiv__firstDiv__internal">
                    ...
                    <div className="internet-maindiv__firstDiv__internal__css pb-3">
                      <CircularProgressbar
                        value={percentage}
                        // text={`${percentage}/100%`}
                        strokeWidth={2}
            ...
            <div className="col-sm-6 col-md-5 col-lg-4 pe-0">
              <div className="internet-maindiv__firstDiv h-100">
                <button
                  style={{
                    float: "right",
