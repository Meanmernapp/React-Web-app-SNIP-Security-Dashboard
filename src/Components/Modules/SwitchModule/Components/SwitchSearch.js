...
import SwitchDownloadFileModal from "./Modal/SwitchDownloadFileModal";
import AddImageModal from "./Modal/SwitchSearchModal";
      ...
      <div className="container-size">
        <div className="container-fluid">
          ...
          <div className="card-class mr-3">
            ...
            </div> <div className="switch-example  mb-3 pt-3">
              <div className="px-3">
                <div className="row float-end mr-2 ">
                  <button
                    className=" col-12 department-create-header__button"
