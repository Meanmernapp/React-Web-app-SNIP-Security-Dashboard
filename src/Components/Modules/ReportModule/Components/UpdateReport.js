...
import PickImageModal from "../Modal/pickImageModal";
...
const handleUpload=()=>{
  ...
  return (
    <div
      className="home">
      <div className="container-size" style={{float:"unset"}}>
        ...
        <div className="report-create report-update row">
            ...
            <div className="create-report-mainDiv col-sm-12 col-md-12 col-lg-12 col-xl-12">
              ...
              <div className="report-info__detail col-sm-12 col-md-12 col-lg-10 col-xl-10">
                <div className="report-rightColumn__update ">
                  ...
                  <button className="report-model-confirm-btn-style col-10">
                    <img
                      src={edit_white}
          ...
          <div className="col-md-10 col-lg-6 col-xl-6">
            ...
            <div className="report-update-right-col__box col-10">
              <p className="report-update-right-col__box__p col-10" style={{cursor:"pointer"}} onClick={handleUpload}>
        ...
        <div className="updateReport-footer-buttons row my-5">
