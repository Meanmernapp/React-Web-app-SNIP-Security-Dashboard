...
export default function CreateCaso() {
  ...
  function getSteps() {
    ...
    return [
      ...
      <b>{t('event_details')}</b>,
      <b>{t('investigador')}</b>,
      <b>{t('specific_data_of_the_case')}</b>,
      <b>{t('evidences')}</b>,
    ];
  }
        ...
        return (
          ...
          >
            <div className="input-group-report">
              <label className="input-group-report__label">{t('place')}</label>
              <input
      ...
      case 1:
        return (
          <form onSubmit={(e) => handleSubmit(e)} class="form-crear-new-caso">
            ...
            <div className="input-group-report">
              <label className="input-group-report__label">{t('home')} </label>
              <textarea
                class="form-control"
        ...
        return (
          <div className="mb-3">
            <div className="row pt-3 justify-content-center">
              <div
                className=" create-case-background pt-2 col-sm-6 mt-2 col-md-4 col-lg-2 "
              ...
              <div
                className=" create-case-background pt-2 col-sm-6 col-md-4 mt-2 col-lg-2"
                style={{ width: "160px", height: "120px" }}
              >
                <input type="checkbox" className="float-end mb-2" />
                <div className="row">
        ...
        return (
          <form class="form-crear-new-caso">
            <div className="input-group-report form-group-report">
              <label className="input-group-report__label">{t('status')}</label>
            ...
            <div className="input-group-report">
              <label className="input-group-report__label">{t('description')}</label>
              <textarea
                name={description}
                value={description}
        ...
        return (
          <form class="mb-4">
            <div className="row justify-content-center">
              <div className="col-sm-10 col-lg-6 vl-int">
                <div style={{ width: "430px", float: "right" }}>
                  <div className="w-75 mx-auto">
                    <div className="level-end text-start" style={{ width: "20em", margin: "auto" }}>{t('reportes')}</div>
                    <div className="images-model-body__addImage-upload-one mx-auto py-3">
                      <div className="images-model-row-one ">
                        <img
                          src={cloud}
                          style={{ height: "4.5rem", marginRight: "20px" }}
                        />

                        <p className="images-model-body__p" style={{ fontSize: "12px" }}>
                  ...
                  <div className="grupos-card p-2 mt-3">
                    <div className="row py-1">
                      <div className="px-2 col-10 d-flex justify-content-start align-items-center">
                        <img src={ic_pdf} style={{ height: "2.5rem", marginRight: "10px", marginLeft: "20px" }} />
                        <div className="">
              ...
              <div className="col-sm-10 col-lg-6">
                <div style={{ width: "430px", float: "left" }}>
                  <div className="w-75 mx-auto">
                    <div className="level-end text-start" style={{ width: "20em", margin: "auto" }}>{t('images')}</div>
                    <div className="images-model-body__addImage-upload-one mx-auto py-3">
                      <div className="images-model-row-one ">
                        <img
                          src={cloud}
                  ...
                  <div className="mt-3">
                    <div className="cases-file-box me-4">
                      <img
                        src={ic_trash_outline}
                        className="cases-file-box__deleteImage"
                      />
                      <img
                        src={ic_pdf}
                        className="cases-file-box__fileImage"
                      />
                      <p>caso_1.jpg</p>
                      <span>
                        TAMAÑO: 18 MB.
