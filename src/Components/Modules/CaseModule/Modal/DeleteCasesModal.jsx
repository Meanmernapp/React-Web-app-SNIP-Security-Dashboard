...
function DeleteCasesModal(props) {
  ...
  return (
    <div>
      <Modal
        ...
        <h3 className="deparment-follow-modal__header text-center">{t('delete_cases')}</h3>
        <div className="body">
          <h6 className="mb-3">
          {t('the_following_information_will_be_removed_from_the_selected_cases')}
          </h6>
          <span className="mb-2">
